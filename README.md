# STAR_track
## Overview
**STAR_track** is an automated, highly-configurable framework for deep learning applied to geospatial and Earth observation data. It enables fast prototyping, training, evaluation, and large-scale inference of segmentation models on satellite and remote sensing imagery. The framework builds on PyTorch Lightning, TorchGeo, and MLflow, providing powerful experiment tracking, reproducibility, and spatially-aware data handling.
